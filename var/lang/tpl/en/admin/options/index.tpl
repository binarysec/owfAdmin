...
<script type="text/javascript">
	function ask_change_lang() {
		$('<div>').simpledialog2({
			...
			headerClose: true,
			buttonPrompt: '<strong>You will be redirected on the main page. Do you want to continue?</strong>',
			buttons : {
				'OK': {
...
<div class="content-secondary">
	...
	<li class="ui-btn-icon-right ui-li-has-arrow ui-li.ui-corner-top ui-btn-up-a">Super administrator</li>
	%{elseif isset($perms["session:admin"])}%
	<li class="ui-btn-icon-right ui-li-has-arrow ui-li.ui-corner-top ui-btn-up-a">Administrator</li>
	%{elseif isset($perms["session:ws"])}%
	<li class="ui-btn-icon-right ui-li-has-arrow ui-li.ui-corner-top ui-btn-up-a">Web service</li>
	%{/if}%
